...
BLOG_TITLE = "FVTool"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://fvt.simulkade.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://fvt.simulkade.com"
BLOG_EMAIL = "a.a.eftekhari@outlook.com"
BLOG_DESCRIPTION = "A finite volume tool in Matlab and Julia"  # (translatable)
